...
const TRANSLATIONS = {
  en: {
    ...
    delivery: 'Delivery',
    warranty_note: '2-year warranty on all parts & labor. Contact support if anything needs attention.',
  ...
  sk: {
    ...
    delivery: 'Doručenie',
    warranty_note: 'Dvojročná záruka na všetky diely a prácu. V prípade problémov kontaktujte podporu.',
  ...
  cz: {
    ...
    components: 'Komponenty',
    delivery: 'Doručení',
    warranty_note: 'Dvouletá záruka na všechny díly a práci. V případě problémů kontaktujte podporu.',
